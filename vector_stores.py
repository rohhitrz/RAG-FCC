...
def metadata_filtering():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        query="what databases are available now?"

        # without metadata filtering
        results= vectorstores.similarity_search(query, k=5)
        ...
        filtered_results= vectorstores.similarity_search(query,k=5,filter=filter_criteria)
